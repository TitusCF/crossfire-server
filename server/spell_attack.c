...
/**
 * Basically, we move 'op' one square, and if it hits something, call
 * check_bullet. This function is only applicable to bullets, but not to all
...
/** This handles ball type spells that just sort of wander about. was called
 * move_ball_lightning, but since more than the ball lightning spell used it,
 * that seemed misnamed.
 *
