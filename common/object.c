...
/**
 * Finds the best weapon a player has by name.
 *
 * Gros has put find_best_weapon_used_match in arch.c but it manipulates 
 * only objects so i moved it here.    -tchize
 *
 * @param pl
 * object we search the inventory of
 * @param params
 * name of weapon. Can be partial, or such.
 * @return
 * matching weapon, or NULL if none matches.
 */
