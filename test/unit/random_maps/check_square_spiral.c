/*
 * static char *rcsid_check_square_spiral_c =
 *   "$Id$";
 */
...
/*
 * This is the unit tests file for random_maps/square_spiral.c
 */
...
Suite *square_spiral_suite(void)
{
  Suite *s = suite_create("square_spiral");
