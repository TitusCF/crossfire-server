...
/*
 * This is the unit tests file for random_maps/monster.c
 */
...
int main(void)
{
  ...
  srunner_set_xml(sr,LOGDIR "/unit/random_maps/monster.xml");
  srunner_set_log(sr,LOGDIR "/unit/random_maps/monster.out");
