...
extern int surround_flag ( char **layout, int i, int j ,RMParms *);
extern int surround_flag2 ( char **layout, int i, int j, RMParms *);
extern int surround_flag3 ( mapstruct *map, int i, int j, RMParms * );
extern int surround_flag4 ( mapstruct *map, int i, int j, RMParms * );
