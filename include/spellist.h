...
{"cure disease",               5,30,  0, 10, 3, 5,  1,  0, 0, 1, 1,
 PATH_RESTORE,NULL},
  /* NOTE DO NOT CHANGE SPELL PATH FOR DISEASE SPELLS.
	  THEY ARE SET TO PATH_NULL TO KEEP THEM OUT OF THE HANDS OF PLAYERS,
	  UNTIL THEY HAVE BEEN BALANCED. */
{"cause red death",           20,999, 0, 10, 0, 0,  0,  1, 0, 1, 0,
 PATH_NULL,"ebola"},
{"cause flu",                  2, 10, 0, 10, 0, 0,  0,  1, 0, 1, 0,
 PATH_WOUNDING,"flu"},
{"cause black death",         15, 999, 0, 10, 0, 0,  0,  1, 0, 1, 0,
 PATH_NULL,"bubonic_plague"},
{"cause leprosy",              5, 20, 0, 10, 0, 0,  0,  1, 0, 1, 0,
 PATH_WOUNDING,"leprosy"},
{"cause smallpox",            20,999, 0, 10, 0, 0,  0,  1, 0, 1, 0,
 PATH_NULL,"smallpox"},
{"cause plague",              20,999, 0, 10, 0, 0,  0,  1, 0, 1, 0,
 PATH_NULL,"pneumonic_plague"},
{"cause anthrax",             12, 999, 0, 10, 0, 0,  0,  1, 0, 1, 0,
 PATH_NULL,"anthrax"},
{"cause typhoid",             15, 999, 0, 10, 0, 0,  0,  1, 0, 1, 0,
   PATH_NULL,"typhoid"},
