 ...
 *
 *   Created: Fri Apr 21 23:08:48 2000
 */
#ifndef __CEXTRACT__
#ifdef __STDC__
...
extern void become_follower ( object *op, char *godname );
...
extern int move_ob ( object *op, int dir );
extern void transfer_ob ( object *op, int x, int y );
extern void teleport ( object *teleporter, unsigned char tele_type );
...
extern object * find_key ( object *pl, object *inv, object *door );
...
extern void deep_swamp ( object *op, int walk_on );
