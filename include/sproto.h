 ...
 *
 *   Created: Thu Mar 29 23:46:17 2001
 */
#ifndef __CEXTRACT__
#ifdef __STDC__
...
extern int hit_player_attacktype ( object *op, object *hitter, int dam, uint32 attacknum, int magic );
...
extern void set_map_timeout ( mapstruct *oldmap );
extern char *clean_path ( char *file );
extern char *unclean_path ( char *src );
...
extern int change_skill_to_skill ( object *who, object *skill );
...
extern void check_cone_push ( object *op );
