...
/* GROS - These are for script_... fields */
  V_SCRIPT_LOAD, V_SCRIPT_APPLY, V_SCRIPT_SAY, V_SCRIPT_TRIGGER, V_SCRIPT_TIME,
  V_SCRIPT_ATTACK, V_SCRIPT_DROP, V_SCRIPT_THROW, V_SCRIPT_STOP, V_SCRIPT_DEATH, V_CURRENT_WEAPON_SCRIPT,
  V_START_SCRIPT_LOAD, V_START_SCRIPT_APPLY, V_START_SCRIPT_SAY, V_START_SCRIPT_TRIGGER, V_START_SCRIPT_TIME,
  V_START_SCRIPT_ATTACK, V_START_SCRIPT_DROP, V_START_SCRIPT_THROW, V_START_SCRIPT_STOP, V_START_SCRIPT_DEATH,
  V_END_SCRIPT_LOAD, V_END_SCRIPT_APPLY, V_END_SCRIPT_SAY, V_END_SCRIPT_TRIGGER, V_END_SCRIPT_TIME,
  V_END_SCRIPT_ATTACK, V_END_SCRIPT_DROP, V_END_SCRIPT_THROW, V_END_SCRIPT_STOP, V_END_SCRIPT_DEATH,
  NR_OF_VARIABLES
};
