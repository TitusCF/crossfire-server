...
extern object *object_find_by_name(const char *str);
...
extern void object_free(object *ob);
...
extern object *arch_present_in_map(const archetype *at, mapstruct *m, int x, int y);
extern object *object_present_in_map(uint8 type, mapstruct *m, int x, int y);
