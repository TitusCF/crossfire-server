...
extern int check_altar ( object *altar );
extern object *check_altar_sacrifice ( object *altar );
...
extern void check_trigger ( object *op );
extern void check_walk_on ( object *op );
...
extern void decrease_ob_nr ( object *op, int i );
...
extern void insert_ob_in_map ( object *op, mapstruct *m );
